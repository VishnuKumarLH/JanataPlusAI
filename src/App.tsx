          ...
          <div className="flex items-center gap-2">
            {isAdminLoggedIn && (
              <button 
                ...
                className="inline-flex items-center gap-1 text-[10px] sm:text-xs font-bold uppercase tracking-wider text-red-600 hover:text-red-700 hover:bg-red-50 px-2 py-1 sm:px-2.5 sm:py-1.5 rounded-xl border border-red-100 transition-all cursor-pointer"
              >
